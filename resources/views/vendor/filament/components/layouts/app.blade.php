...
<x-filament::layouts.base :title="$title">
    <div class="filament-app-layout flex w-full min-h-screen overflow-x-clip">
        ...
        <div
            ...
            @endif
            @class([
                'filament-main flex-col gap-y-6 w-screen flex-1 rtl:lg:pl-0 bg-white',
        ...
        >
            <x-filament::topbar :breadcrumbs="$breadcrumbs" class="h-[88px] rounded-full  mt-[20px] ml-[14px] cp-topbar"/>

            <div @class([
                'filament-main-content flex-1 w-full px-4 mx-auto md:px-6 lg:px-8 h-[88px]',
