<div class="w-full h-full flex flex-col ">
    <div class=" xs:h-[16%] md:h-[8%] flex align-middle w-screen xs:py-[5px] md:py-[18px] bg-primaryGray">
        <img src="{{ url('assets/loginbanner.svg') }}" class=" ml-[25%] xs:hidden md:block" alt="image" />
        <img src="{{ url('assets/loginbanner.svg') }}" class=" w-[40%] py-9 h-[144%] ml-[25%] xs:block md:hidden"
            alt="image" />
    </div>
    <div class="lg:flex  justify-center align-middle gap-20 xs:h-[88%]  md:h-[90%] overflow-hidden">
        ...
        <div class="flex flex-col justify-center">
            ...
            <span class="text-center lg:mt-4 lg:mb-7 sm:mt-1 sm:mb-5 mb-10 text-grayText font-[500]">or</span>
